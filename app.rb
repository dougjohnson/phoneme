...
post '/call-handler' do
  ...
  response = Twilio::TwiML::Response.new do |r|
    r.Say 'Hello, '+numbers[params['Called']]+'. The Sage One application has stopped responding. This phone call has been triggered as a result of pingdom being unable to contact the site for three consecutive minutes.', :voice => 'man', :language => 'en-gb'
  end
